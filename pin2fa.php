...
<body>
  <div class="formWrapper">
    <form id="verifyPinForm">
      <h1>Pin Verification(2FA)</h1>
      <div id="errs" class="errorcontainer"></div>
      <div class="inputblock">
        <label for="pin">Pin</label>
        <input id="pin" name="pin" type="text" required placeholder="Enter the pin from your messages" onkeydown="if(event.key === 'Enter'){event.preventDefault();sendPinVerificationRequest();}"/>
      </div>
      <br>
      <div class="btn" onclick="sendPinVerificationRequest();">Verify Pin</div>
    </form>
